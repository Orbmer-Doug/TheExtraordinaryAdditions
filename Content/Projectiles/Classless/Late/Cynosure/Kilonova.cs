...
public class Kilonova : ModProjectile
{
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Main.spriteBatch.EnterShaderRegion(nova.Shader.Value, BlendState.AlphaBlend);
        Texture2D tex = AssetRegistry.InvisTex;
        Main.spriteBatch.Draw(tex, Projectile.Center - Main.screenPosition, null,
            Color.White * Projectile.Opacity * 0.42f, Projectile.rotation, tex.Size() * 0.5f, Projectile.scale * 400f,
            0, 0f);
