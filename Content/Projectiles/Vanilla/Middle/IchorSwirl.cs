...
public class IchorSwirl : ModProjectile
{
    ...
    {
        // Thanks to auto nerf of i-frames when a projectile is set this one also has to exist instead of being all in ichor stream
        Projectile.width =
    ...
    public override void AI()
    {
        ...
        if (Time > 3f)
        {
            ...
            for (int i = 0; i < arms; i++)
            {
                ...
                swirl.velocity += Projectile.velocity * 0.5f;
