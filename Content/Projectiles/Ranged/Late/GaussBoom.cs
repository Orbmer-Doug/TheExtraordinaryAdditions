    ...
    public override void AI()
    {
        ...
        if (Projectile.ai[0] == 0f)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                Vector2 vel = (MathHelper.TwoPi * i / count + RandomRotation()).ToRotationVector2() *
                              Main.rand.NextFloat(12f, 22f);
                ...
                ParticleRegistry.SpawnGlowParticle(pos, vel * Main.rand.NextFloat(.6f, 1f), lifetime, scale * 60f,
                    color, Main.rand.NextFloat(.7f, 1.3f));
                ParticleRegistry.SpawnBloomLineParticle(pos, vel.RotatedByRandom(.4f) * 1.4f, lifetime / 2, scale * .9f,
                    color);
            }
            ...
            for (int a = 0; a < 5; a++)
            {
                ...
                ParticleRegistry.SpawnDetailedBlastParticle(pos, Vector2.Zero, end, Vector2.Zero, life, randomColor,
                    null, auraColor, true);
            }
