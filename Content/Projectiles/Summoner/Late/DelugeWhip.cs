...
public class DelugeWhip : BaseWhip
{
    ...
    {
        for (int i = 0; i < 20; i++)
            MetaballRegistry.SpawnAbyssalMetaball(Tip, Main.rand.NextVector2Circular(5f, 5f), Main.rand.Next(30, 40),
    ...
    public void Visuals()
    {
        Projectile.scale = MathHelper.Lerp(.9f, 1.2f, GetLerpBump(0f, .4f, 1f, .6f, Completion)) *
