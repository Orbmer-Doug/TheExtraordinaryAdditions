...
public class BrewingStormsHoldout : BaseIdleHoldoutProjectile
{
    ...
    public override void SafeAI()
    {
        ...
        if (this.RunLocal() && Charge >= ChargeNeeded)
        {
            ...
            Projectile.NewProj(pos, vel, ModContent.ProjectileType<BrewingLightningStrike>(), (int) (Item.damage * 3f),
                0f, Projectile.owner, vel.ToRotation(), Main.rand.Next(150), 0f);
