...
public sealed class FlagPolePlaced : ModTile
{
    // In terms of tiles
    ...
    public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
    {
        ...
        const int verticalOffset = 1 - Height;
        ...
        VertexColors colors = new VertexColors(lightColorTopLeft, lightColorTopRight, lightColorBottomRight,
            lightColorBottomLeft);
...
public sealed class FlagTileEntity : ModTileEntity, IClientSideTileEntityUpdater
{
    /// <summary>
    /// The flag cloth that this tile entity holds locally
    /// </summary>
    public ClothSimulationTiles FlagCloth { get; private set; } = new ClothSimulationTiles(30, 15, 3.3f);
    ...
    {
        FlagCloth?.Update(new Vector2(Position.X, Position.Y + FlagCloth.GridHeight / 16f).ToWorldCoordinates());
    }

    public override int Hook_AfterPlacement(int i, int j, int type, int style, int direction, int alternate)
    {
        // If in multiplayer, tell the server to place the tile entity and DO NOT place it yourself.
        // That would mismatch IDs
...
public sealed class ClientServerTileEntityUpdateSystem : ModSystem
{
