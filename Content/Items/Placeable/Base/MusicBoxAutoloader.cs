...
public static class MusicBoxAutoloader
{
    ...
    public static void Create(Mod mod, string texturePathBase, string musicPath, out int itemID, out int tileID)
    {
        // Autoload the item.
        AutoloadableMusicBoxItem boxItem = new($"{texturePathBase}_Item", musicPath);
