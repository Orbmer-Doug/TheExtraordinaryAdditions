...
public class WrithingLight : ModItem
{
    ...
    public override void PostUpdate()
    {
        ...
        {
            Dust obj = Dust.NewDustPerfect(Item.Hitbox.RandomRectangle(), DustID.Torch,
                Vector2.UnitY.RotatedByRandom(.2f) * -Main.rand.NextFloat(2f, 6f), 0, default, 1f);
            obj.velocity = Vector2.Lerp(Main.rand.NextVector2Unit(0f, MathHelper.TwoPi), -Vector2.UnitY, 0.5f) *
