...
public class CrossDisc : ModItem
{
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var balls = new TooltipLine(Mod, "CrossDisc", this.GetLocalization("game").Value)
        {
            OverrideColor = new Color(163, 209, 208)
        };
        var gudgame = new TooltipLine(Mod, "CrossDisc", this.GetLocalization("game").Value)
        {
            OverrideColor = new Color(132, 173, 217)
        };
