...
public class AridFlask : ModItem
{
    public override string Texture => AssetRegistry.GetTexturePath(AdditionsTexture.AridFlask);
    ...
    public override void SetDefaults()
    {
        ...
        Item.buffType = ModContent.BuffType<DesertsBlessing>();
    ...
    public override void AddRecipes()
    {
        ...
        recipe.AddIngredient(ModContent.ItemType<FulguriteInAJar>(), 1);
