...
public class MimicryCooldown : CooldownHandler
{
    ...
    public override void Tick()
    {
        ...
        {
            ParticleRegistry.SpawnPulseRingParticle(instance.player.RandAreaInEntity(), instance.player.velocity, 20,
                RandomRotation(), new(Main.rand.NextFloat(.4f, .8f), 1f), 0f, 60f, Color.Crimson, true);
        }
    }
}
*/
