...
public partial class Asterlin
{
    public static readonly Dictionary<AsterlinAIType, float> Disintegration_PossibleStates =
        new Dictionary<AsterlinAIType, float>
            { { AsterlinAIType.Lightripper, 1f }, { AsterlinAIType.Tesselestic, .6f } };
    ...
    public void LoadStateTransitions_Disintegration()
    {
        StateMachine.RegisterTransition(AsterlinAIType.Disintegration, Disintegration_PossibleStates, false,
            () => Disintegration_CurrentShot >= Disintegration_TotalShots &&
                  !AnyProjectile(ModContent.ProjectileType<VaporizingStar>()));
    ...
    public void DoBehavior_Disintegration()
    {
        ...
        if (AITimer > Disintegration_HoverTime)
        {
            ...
            Projectile star1 = Main.projectile?[Disintegration_Star1Index];
            Projectile star2 = Main.projectile?[Disintegration_Star2Index];
            if (star1 != null)
