...
{
    public static readonly Dictionary<AsterlinAIType, float> EnterPhase2_PossibleStates =
        new Dictionary<AsterlinAIType, float> { { AsterlinAIType.Tesselestic, 1f } };

    [AutomatedMethodInvoke]
    public void LoadStateTransitions_EnterPhase2()
    {
        StateMachine.RegisterTransition(AsterlinAIType.EnterPhase2, EnterPhase2_PossibleStates, false,
            () => AITimer >= EnterPhase2_Length);
