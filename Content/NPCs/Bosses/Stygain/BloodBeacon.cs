...
public class BloodBeacon : ProjOwnedByNPC<StygainHeart>
{
    ...
    {
        sound ??= new(AssetRegistry.GetSound(AdditionsSound.BraveSpecialN03Loop), () => new ProjectileAudioTracker(Projectile).IsActiveAndInGame());
        sound.Update(() => Projectile.Center, () => Completion, () => -.1f);
