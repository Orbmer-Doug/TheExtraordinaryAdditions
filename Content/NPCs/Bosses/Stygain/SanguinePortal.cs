    ...
    public override void OnKill(int timeLeft)
    {
        ...
        for (int i = 0; i < ringCount; i++)
        {
            for (int j = 0; j < eyeCount; j++)
            {
                ...
                WrithingEyeball eye = Main.projectile[SpawnProjectile(Projectile.Center, vel,
                    ModContent.ProjectileType<WrithingEyeball>(), StygainHeart.BloodshotDamage, 0f)].As<WrithingEyeball>();
                eye.Free = true;
            }
