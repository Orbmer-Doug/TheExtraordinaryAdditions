...
public class BloodShot : ProjOwnedByNPC<StygainHeart>
{
    ...
    {
        Projectile.Opacity = InverseLerp(250f, 230f, Projectile.timeLeft);
        ...
        if (PlayerTargeting.TryFindClosestPlayer(new(Projectile.Center, 1500), out Player closest))
        {
            ...
            Projectile.velocity = Vector2.Lerp(Projectile.velocity,
                Projectile.SafeDirectionTo(closest.Center) * Projectile.velocity.Length(), 0.031f);
        }
    }
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Main.spriteBatch.Draw(texture, drawPosition, null, color, Projectile.rotation, origin, Projectile.scale * 0.9f,
            0, 0);
        ...
        Main.spriteBatch.Draw(texture, drawPosition, null, bigGleamColor, MathHelper.PiOver2, origin, bigGleamScale, 0,
            0);
