...
public class RaritySpark : Behavior<RarityParticleInfo>
{
    ...
    public override void Draw(SpriteBatch sb, Vector2 position, DrawableTooltipLine line)
    {
        ...
        sb.Draw(Info.Texture, position, null, Info.DrawColor * .15f * Info.Opacity, Info.Rotation, orig,
            new Vector2(.5f, 1.4f) * Info.Scale * 2f, 0, 0f);
        sb.Draw(Info.Texture, position, null, Info.DrawColor.Lerp(Color.White, .1f) * .5f * Info.Opacity, Info.Rotation,
            orig, new Vector2(.4f, 1.2f) * Info.Scale * 1.5f, 0, 0f);
        sb.Draw(Info.Texture, position, null, Info.DrawColor.Lerp(Color.White, .2f) * Info.Opacity, Info.Rotation, orig,
