...
public sealed class ParticleSystem : ModSystem
{
    ...
    private const uint maxParticles = 32768; // 2^15
    private static ParticleData[] particles;
    private static ulong[] presenceMask;
    public static BitmaskUtils.BitmaskEnumerator ActiveParticles => new BitmaskUtils.BitmaskEnumerator(presenceMask, maxParticles);
