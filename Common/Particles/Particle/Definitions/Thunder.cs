...
public partial class ParticleRegistry
{
    ...
    public static void SpawnThunderParticle(Vector2 position, int lifetime, float scale, Vector2 squish, float rotation, Color color, float opacity = 1f, float shakePower = 20f)
    {
