...
public class AdditionsRecipes : ModSystem
{
    ...
    private static void AddOreAndBarRecipeGroups()
    {
        ...
        group = new RecipeGroup(() => Language.GetTextValue("Misc.RecipeGroup.AnyEvilBar"),
    ...
    {
        RecipeGroup group = new(() => Language.GetTextValue("Misc.RecipeGroup.AnyEvilPowder"),
            [ItemID.VilePowder, ItemID.ViciousPowder]);
        AnyEvilPowder = RecipeGroup.RegisterGroup("AnyEvilPowder", group);

        group = new RecipeGroup(() => Language.GetTextValue("Misc.RecipeGroup.Boss2Material"),
            [ItemID.ShadowScale, ItemID.TissueSample]);
        Boss2Material = RecipeGroup.RegisterGroup("Boss2Material", group);

        group = new RecipeGroup(() => Language.GetTextValue("Misc.RecipeGroup.CursedFlameIchor"),
            [ItemID.CursedFlame, ItemID.Ichor]);
        CursedFlameIchor = RecipeGroup.RegisterGroup("CursedFlameIchor", group);

        group = new RecipeGroup(() => Language.GetTextValue("Misc.RecipeGroup.AnyEvilWater"),
            [ItemID.UnholyWater, ItemID.BloodWater]);
        AnyEvilWater = RecipeGroup.RegisterGroup("AnyEvilWater", group);

        group = new RecipeGroup(() => Language.GetTextValue("Misc.RecipeGroup.AnyEvilFlask"),
            [ItemID.FlaskofCursedFlames, ItemID.FlaskofIchor]);
    ...
    {
        RecipeGroup group =
            new(() => Language.GetTextValue("LegacyMisc.37") + " " + Lang.GetItemNameValue(ItemID.WoodenSword), [
                ItemID.WoodenSword, ItemID.BorealWoodSword,
                ItemID.RichMahoganySword, ItemID.PalmWoodSword, ItemID.EbonwoodSword, ItemID.ShadewoodSword,
                ItemID.PearlwoodSword, ItemID.AshWoodSword
            ]);
        AnyWoodenSword = RecipeGroup.RegisterGroup("AnyWoodenSword", group);

        group = new RecipeGroup(
            () => Language.GetTextValue("LegacyMisc.37") + " " + Lang.GetItemNameValue(ItemID.HallowedHelmet), [
                ItemID.HallowedHelmet,
                ItemID.HallowedHeadgear, ItemID.HallowedMask, ItemID.HallowedHood, ItemID.AncientHallowedHelmet,
                ItemID.AncientHallowedHeadgear, ItemID.AncientHallowedHood, ItemID.AncientHallowedMask
            ]);
        AnyHallowedHelmet = RecipeGroup.RegisterGroup("AnyHallowedHelmet", group);

        group = new RecipeGroup(
            () => Language.GetTextValue("LegacyMisc.37") + " " + Lang.GetItemNameValue(ItemID.HallowedPlateMail),
            [ItemID.HallowedPlateMail, ItemID.AncientHallowedPlateMail]);
        AnyHallowedPlatemail = RecipeGroup.RegisterGroup("AnyHallowedPlatemail", group);

        group = new RecipeGroup(
            () => Language.GetTextValue("LegacyMisc.37") + " " + Lang.GetItemNameValue(ItemID.HallowedGreaves),
            [ItemID.HallowedGreaves, ItemID.AncientHallowedGreaves]);
        ...
        group = new RecipeGroup(() => Language.GetTextValue("Misc.RecipeGroup.LunarPickaxe"),
            [ItemID.SolarFlarePickaxe, ItemID.VortexPickaxe, ItemID.NebulaPickaxe, ItemID.StardustPickaxe]);
        LunarPickaxe = RecipeGroup.RegisterGroup("LunarPickaxe", group);

        group = new RecipeGroup(() => Language.GetTextValue("Misc.RecipeGroup.LunarHamaxe"),
            [ItemID.LunarHamaxeSolar, ItemID.LunarHamaxeVortex, ItemID.LunarHamaxeNebula, ItemID.LunarHamaxeStardust]);
        LunarHamaxe = RecipeGroup.RegisterGroup("LunarHamaxe", group);

        group = new RecipeGroup(
            () => Language.GetTextValue("LegacyMisc.37") + " " + Lang.GetItemNameValue(ItemID.ManaFlower),
            [ItemID.ManaFlower, ItemID.ManaCloak, ItemID.MagnetFlower, ItemID.ArcaneFlower]);
        AnyManaFlower = RecipeGroup.RegisterGroup("AnyManaFlower", group);

        group = new RecipeGroup(() => Language.GetTextValue("Misc.RecipeGroup.AnyQuiver"),
            [ItemID.MagicQuiver, ItemID.MoltenQuiver, ItemID.StalkersQuiver]);
        ...
        group = new RecipeGroup(
            ...
            [
                ItemID.Tombstone, ItemID.GraveMarker, ItemID.CrossGraveMarker, ItemID.Headstone, ItemID.Gravestone,
                ItemID.Obelisk, ItemID.RichGravestone1,
        ...
        int[] barbecuechicken =
        [
            ItemID.AngelWings, ItemID.DemonWings, ItemID.RedsWings, ItemID.ButterflyWings, ItemID.FairyWings,
            ItemID.HarpyWings, ItemID.BoneWings, ItemID.FlameWings, ItemID.FrozenWings, ItemID.GhostWings,
            ItemID.SteampunkWings, ItemID.LeafWings, ItemID.BatWings, ItemID.BeeWings, ItemID.DTownsWings,
            ItemID.WillsWings, ItemID.CrownosWings, ItemID.CenxsWings, ItemID.TatteredFairyWings, ItemID.SpookyWings,
            ItemID.Hoverboard, ItemID.FestiveWings, ItemID.BeetleWings, ItemID.FinWings, ItemID.FishronWings,
            ItemID.MothronWings, ItemID.WingsSolar, ItemID.WingsVortex, ItemID.WingsNebula, ItemID.WingsStardust,
            ItemID.Yoraiz0rWings, ItemID.JimsWings, ItemID.SkiphsWings, ItemID.LokisWings, ItemID.BetsyWings,
            ItemID.ArkhalisWings, ItemID.LeinforsWings, ItemID.BejeweledValkyrieWing, ItemID.GhostarsWings,
            ItemID.GroxTheGreatWings,
            ItemID.FoodBarbarianWings, ItemID.SafemanWings, ItemID.CreativeWings, ItemID.RainbowWings,
            ItemID.LongRainbowTrailWings, ModContent.ItemType<WingsOfTwilight>()
        ];
    ...
    {
        RecipeGroup group = new RecipeGroup(() => Language.GetTextValue("LegacyMisc.37") + " " + "Butterfly",
        [
            ItemID.GoldButterfly, ItemID.HellButterfly, ItemID.JuliaButterfly, ItemID.MonarchButterfly,
            ItemID.PurpleEmperorButterfly, ItemID.RedAdmiralButterfly, ItemID.SulphurButterfly,
            ItemID.TreeNymphButterfly, ItemID.UlyssesButterfly
        ]);
