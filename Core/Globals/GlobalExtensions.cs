...
public static class GlobalExtensions
{
    ...
    public static AdditionsGlobalProjectile Additions(this Projectile projectile) =>
        projectile.GetGlobalProjectile<AdditionsGlobalProjectile>();

    public static AdditionsProjectileInfo AdditionsInfo(this Projectile projectile) =>
        projectile.GetGlobalProjectile<AdditionsProjectileInfo>();

    public static ProjectileDamageModifiers ProjDamageMod(this Projectile projectile) =>
        projectile.GetGlobalProjectile<ProjectileDamageModifiers>();
