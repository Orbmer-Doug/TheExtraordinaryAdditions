...
public static class ItemUtils
{
        ...
        bool stepDisplace = true)
    {
        ...
        if (stepDisplace)
        {
            ...
            if ((frame > 6 && frame < 10) || (frame > 13 && frame < 17)) finalPosition -= Vector2.UnitY * 2f;
        }
    ...
    extension(List<TooltipLine> tooltips)
    {
            ...
            bool hideNormalTooltip = false)
        {
            ...
            for (int i = 0; i < tooltips.Count; i++)
                ...
                {
                    if (firstTooltipIndex == -1) firstTooltipIndex = i;
        ...
        public void DeleteTooltips() => tooltips.RemoveAll(l => l.Name.Contains("Tooltip"));
    ...
    public static void AddTooltips(ModItem item, string[] tooltips)
    {
        ...
        for (int i = 0; i < tooltips.Length; i++)
            supertip = supertip + tooltips[i] + (i == tooltips.Length - 1 ? string.Empty : "\n");
    }
