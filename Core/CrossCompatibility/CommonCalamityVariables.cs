...
namespace TheExtraordinaryAdditions.Extraordinary.CrossCompatibility;
...
public static partial class CommonCalamityVariables
{
    ...
    public static bool TryGetFromModCall<T>(out T result, params string[] modCallInfo)
    {
        ...
        if (ModReferences.BaseCalamity is not null)
        {
            ...
            object callResult = ModReferences.BaseCalamity.Call(modCallInfo);
    ...
    public static void TrySetFromModCall(object value, params string[] modCallInfo)
    {
        ...
        ModReferences.BaseCalamity.Call(modCallInfo, value);
    }
}
