...
{
    public readonly struct BlockCondition(bool input, bool ui, Func<bool> blockIsActiveCondition)
    {
        public readonly bool BlockInputs = input;

        public readonly bool BlockUI = ui;

        public readonly Func<bool> BlockIsInEffect = blockIsActiveCondition;
