...
public class AbsoluteTorsoDrawer : ModSystem
{
    ...
    public override void OnModLoad()
    {
        ...
        {
            ArmorOutlineTexture = AssetRegistry.GennedTextures.AbsoluteCoreplate_Body;
        }
    ...
    private void PrepareAfterimageTarget()
    {
        ...
        if (Main.gameMenu || !anyoneIsUsingTorso)
            return;
        ...
        var aura = AssetRegistry.GennedShaders.ViscousAfterimageShader;
        aura.TrySetParameter("uScreenResolution", Main.ScreenSize.ToVector2());
        aura.TrySetParameter("warpSpeed", 0.00280f);
        aura.SetTexture(AssetRegistry.GennedTextures.TurbulentNoise, 1);
        aura.Render();
    ...
    {
        var shader = AssetRegistry.GennedShaders.ViscousVoidShader;
        shader.TrySetParameter("colorShift", Color.AntiqueWhite.ToVector3());
        shader.TrySetParameter("lightDirection", Vector3.UnitZ);
        shader.TrySetParameter("normalMapCrispness", 0.086f);
        shader.TrySetParameter("normalMapZoom", new Vector2(0.7f, 10.4f));
        shader.SetTexture(AssetRegistry.GennedTextures.TurbulentNoise, 1);
        shader.SetTexture(AssetRegistry.GennedTextures.MeltNoise, 2);
        shader.SetTexture(AssetRegistry.GennedTextures.WavyNeurons, 3);
        shader.Render();
    ...
    public static void ApplyPsychedelicDiffusionEffects()
    {
        ...
        var afterimageShader = AssetRegistry.GennedShaders.ViscousAfterimageShader;
        ...
        afterimageShader.SetTexture(AssetRegistry.GennedTextures.noise, 1);
