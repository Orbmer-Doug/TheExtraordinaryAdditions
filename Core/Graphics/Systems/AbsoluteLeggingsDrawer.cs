...
public class AbsoluteLeggingsDrawer : ModSystem
{
    ...
    public override void OnModLoad()
    {
        ...
        {
            ArmorOutlineTexture = AssetRegistry.GennedTextures.AbsoluteGreaves_Legs;
        }
    ...
    private void PrepareAfterimageTarget()
    {
        ...
        if (Main.gameMenu || !anyoneIsUsingLeggings)
            return;
    ...
    {
        ManagedShader shader = AssetRegistry.GennedShaders.ViscousVoidShader;
    ...
    public static void ApplyPsychedelicDiffusionEffects()
    {
        ...
        afterimageShader.SetTexture(AssetRegistry.GennedTextures.TurbulentNoise, 1);
