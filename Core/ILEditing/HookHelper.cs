...
// Source of HookHelper and the following interfaces is from Luminance
public static class HookHelper
{
    ...
    {
        List<Type> existingDetourProvidersColection = GetEveryTypeDerivedFrom<IExistingDetourProvider>(mod.Code).ToList();
        List<Type> customDetourProvidersCollection = GetEveryTypeDerivedFrom<ICustomDetourProvider>(mod.Code).ToList();
